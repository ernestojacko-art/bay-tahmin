...
# Bay Tahmin artık Gemini kullanmaz.
# AI işlemleri ayrı Football AI Agent servisine yönlendirilir.
FOOTBALL_AI_AGENT_BASE_URL = os.getenv(
    "FOOTBALL_AI_AGENT_BASE_URL",
    "https://futbol-ajan.vercel.app"
).rstrip("/")
...
async def analyze_match_with_ai(match_id: int):
    """Seçili maçı doğrudan Football AI Agent motoruyla analiz eder."""
...
async def chat_about_match(match_id: int, request: Request):
    """Seçili maç için profesyonel Football Chat Agent'a yönlendirir."""
    try:
