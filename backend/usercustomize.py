# Runtime hook: Python's platform sitecustomize shadows the repo's sitecustomize.py.
# usercustomize is loaded afterwards and reliably patches the live FastAPI app.
